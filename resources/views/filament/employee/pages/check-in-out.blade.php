                            ...
                            <x-filament::card>
                                <div style="text-align: center; padding: 1rem;">
                                    ...
                                    <p style="font-size: 1.5rem; font-weight: 700; color: rgb(34 197 94);">
                                        {{ $todayAttendance->check_in_time?->format('H:i:s') ?? 'Not checked in' }}
                                    </p>
                                </div>
                            </x-filament::card>
                            ...
                            <x-filament::card>
                                <div style="text-align: center; padding: 1rem;">
                                    ...
                                    <p style="font-size: 1.5rem; font-weight: 700; color: rgb(239 68 68);">
                                        {{ $todayAttendance->check_out_time?->format('H:i:s') ?? 'Not checked out' }}
                                    </p>
                                </div>
                            </x-filament::card>
                        </div>
                    ...
                    <x-filament::card>
                        <div style="text-align: center;">
                            ...
                            <p style="font-size: 1.875rem; font-weight: 700; color: rgb(59 130 246);">
                                {{ $todayAttendance->check_in_time->diff($todayAttendance->check_out_time)->format('%H:%I:%S') }}
                            </p>
                        </div>
                    </x-filament::card>
                @endif
